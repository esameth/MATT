...
#define MAX_OCT_TREE_VERTICES 8
...
int GetEntries2(MatchedBlockPair ** out, void ** tempEnd, OctTreeNode *node, const Vector *coords, double radius);
int GetEntries(MatchedBlockPair ** out, OctTreeNode *node, const Vector *coords, double radius);
