...
Vector *addMulVect(Vector *v1, const Vector *v2, const Vector *v3, double f) {
	v1->x = v2->x + v3->x*f;
	v1->y = v2->y + v3->y*f;
	v1->z = v2->z + v3->z*f;
	return v1;
...
Vector *subMulVect(Vector *v1, const Vector *v2, const Vector *v3, double f) {
	v1->x = v2->x - v3->x*f;
	v1->y = v2->y - v3->y*f;
	v1->z = v2->z - v3->z*f;
	return v1;
...
void mulMat3x3(Matrix *out, const Matrix *in1, const Matrix *in2) {
	...
	for (row = 0; row<3; row++) {
		out->M[row][0] =
			in1->M[row][0] * in2->M[0][0] +
			in1->M[row][1] * in2->M[1][0] +
			in1->M[row][2] * in2->M[2][0];
		out->M[row][1] =
			in1->M[row][0] * in2->M[0][1] +
			in1->M[row][1] * in2->M[1][1] +
			in1->M[row][2] * in2->M[2][1];
		out->M[row][2] =
			in1->M[row][0] * in2->M[0][2] +
			in1->M[row][1] * in2->M[1][2] +
			in1->M[row][2] * in2->M[2][2];
	}
}
